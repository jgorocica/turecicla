...
<body>
	...
	<?php include('../inc/menu.php'); ?>
			...
			<div class="columna columna-m-9 columna-g-9">
				<h1>Mi perfil</h1>
				<img id="avatar" src="<?php echo $dato[0]; ?>user/avatar/<?php echo $datos_perfil['avatar']; ?>" alt="<?php echo $datos_perfil['user']; ?>">



				<br>
				<a onclick="$('#formAvatar #imagenavatar').click();" class="boton boton-pequenio boton-azul">Subir avatar</a>
